    ...
    internal class DatabaseMethods
    {
        ...
        public List<LicensePlateDataDocument> GetLicensePlatesToExport()
        {
            ...
            using (_client = new DocumentClient(new Uri(_endpointUrl), _authorizationKey))
            {
                ...
                licensePlates = _client.CreateDocumentQuery<LicensePlateDataDocument>(collectionLink, new FeedOptions() {MaxItemCount = 100, EnableCrossPartitionQuery = true}).Where(1 => 1.exported == false).ToList();
